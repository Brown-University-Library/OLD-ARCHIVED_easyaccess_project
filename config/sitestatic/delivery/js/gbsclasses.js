...
function gbsProcessSpans(spanElems) {
    ...
    s.setAttribute("src", "//books.google.com/books?jscmd=viewapi&bibkeys=" + bibkeys + "&callback=gbs.ProcessResults");
    //console.debug(this);
    //$('body').append(s);
    document.documentElement.firstElementChild.appendChild(s);
        ...
        case "gbs-thumbnail-large":
            mReq.success.push(function (mReq, bookinfo) {
                ...
                if (bookinfo.thumbnail_url) {
                    ...
                    // Create bookcover thumbnail
                    var img = document.createElement("img");
                    var imgurl = bookinfo.thumbnail_url.replace('&edge=curl', '');
                ...
                //if (bookinfo.preview) {
                //   var preview = bookinfo.preview_url;
                //   var chunk = '<a href="' + preview + '"><img src="https://www.google.com/intl/en/googlebooks/images/gbs_preview_button1.png"/></a>';
                //   var prev = document.createElement("a")
                //   prev.setAttribute(src, preview)
                //   prev.setInnerHTML('<img src="https://www.google.com/intl/en/googlebooks/images/gbs_preview_button1.png"/>');
                //   console.debug(prev);
                   //$('ul.citation').append(chunk);
                //   mReq.span.appendChild(prev);
                //};
            });
            break;
