...
TEST_ILLIAD_GOOD_USERNAME = os.environ['EZACS__COMMON_CLASSES_TEST_ILLIAD_GOOD_USERNAME']
TEST_ILLIAD_DISAVOWED_USERNAME = os.environ['EZACS__COMMON_CLASSES_TEST_ILLIAD_DISAVOWED_USERNAME']
TEST_ILLIAD_BLOCKED_USERNAME = os.environ['EZACS__COMMON_CLASSES_TEST_ILLIAD_BLOCKED_USERNAME']

TEST_ILLIAD_NEW_USER_ROOT = os.environ['EZACS__COMMON_CLASSES_TEST_ILLIAD_NEW_USERNAME_ROOT']
