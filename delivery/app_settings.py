...
SHIB_LOGIN_URL = os.environ['EZACS3__BORROW_SHIB_LOGIN_URL']
SHIB_LOGOUT_URL_ROOT = os.environ['EZACS3__COMMON_SHIB_LOGOUT_URL_ROOT']
SHIB_LOGOUT_URL_RETURN_ROOT = os.environ['EZACS3__BORROW_SHIB_LOGOUT_URL_RETURN_ROOT']
DEVELOPMENT_SHIB_DCT = json.loads( os.environ['EZACS3__COMMON_DEVELOPMENT_SHIB_JSON'] )

AVAILABILITY_URL_ROOT = os.environ['EZACS3__BORROW_AVAILABILITY_URL_ROOT']

PROBLEM_FORM_URL_ROOT = os.environ['EZACS3__BORROW_PROBLEM_FORM_URL_ROOT']
PROBLEM_FORM_KEY = os.environ['EZACS3__BORROW_PROBLEM_FORM_KEY']
